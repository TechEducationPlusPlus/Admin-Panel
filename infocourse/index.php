...
<html lang="en-us">
   <head>
      <title>Infocourse data editor</title>
   ...
   <body>
    ...
    <script>
      $(document).ready(function() {
		...
		$(window.myTable.buttons()[0].inst.dom.container[0]).on ('click', function () {
			$('#addRowBtn').on ('click', function () {
				let data = $(document.getElementsByName ("altEditor-form")[0]).serializeArray();
